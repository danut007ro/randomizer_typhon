...
function init()
    ...
    params:add_number("m1_destinations", "M1 dest. count", 0, 13, 1)
    params:add_number("m1_random_destinations", "M1 random dest. count", 0, 13, 3)
    params:add_option("m2_type", "M2 type", {"YES", "NO"}, 1)
    params:add_number("m2_destinations", "M2 dest. count", 0, 13, 1)
    params:add_number("m2_random_destinations", "M2 random dest. count", 0, 13, 3)
    params:add_option("m3_type", "M3 type", {"YES", "NO"}, 1)
    params:add_number("m3_destinations", "M3 dest. count", 0, 13, 1)
    params:add_number("m3_random_destinations", "M3 random dest. count", 0, 13, 3)
